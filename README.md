...
```bash
vagrant@vagrant-ubuntu-trusty-64:~/AirBnB_clone$ cat test_base_model.py
#!/usr/bin/python3
...
vagrant@vagrant-ubuntu-trusty-64:~/AirBnB_clone$ ./test_base_model.py
...
```bash
vagrant@vagrant-ubuntu-trusty-64:~/AirBnB_clone$ cat test_base_model_dict.py
#!/usr/bin/python3
from models.base_model import BaseModel
...
```bash
vagrant@vagrant-ubuntu-trusty-64:~/AirBnB_clone$ cat test_save_reload_base_model.py
#!/usr/bin/python3
...
```bash
vagrant@vagrant-ubuntu-trusty-64:~/AirBnB_clone$ cat test_save_reload_user.py
#!/usr/bin/python3
from models import storage
from models.base_model import BaseModel
...
* **Ryan Devlin** - [BardoftheOzarks](https://github.com/BardoftheOzarks)
